...
* [EO Browser](https://apps.sentinel-hub.com/eo-browser/?zoom=13&lat=37.71513&lng=-119.18449#search) is another free offering from Sentinel Hub, which has more options to it if you want to play around a bit. Basically navigate around on Topo (the education toggle opens this) or use the search field up top to go where you want, click the large green search button in the EO Browser pane on the left, and then choose the most recent pass that doesn't have a lot of cloud cover. I prefer this over Sentinel Playground. For either it's good to go through their tutorial / walkthrough as the UI is complex.
